...
#define HOMING_BUMP_MM      { 5, 5, 2, 2, 1 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 2, 2, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 12, 20, 15, 5, 0 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 3000, 3000, 2000, 1000, 500 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
#define STARTUP_COMMANDS "M42 P4 S120 \n m410 \n M17 XYZAB \n G92 X0Y0Z0A0B0 \n G91"
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Control Commands"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Home XYZAB"
  #define MAIN_MENU_ITEM_1_GCODE "G28"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Start Rec new Program"
  #define MAIN_MENU_ITEM_2_GCODE "M928 NEW.GCO"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Stop Rec Program"
  #define MAIN_MENU_ITEM_3_GCODE "M29"
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Set Position to Zero"
  #define MAIN_MENU_ITEM_4_GCODE "G92 X0Y0Z0A0B0 \n G91"
  //#define MAIN_MENU_ITEM_2_CONFIRM
  
  #define MAIN_MENU_ITEM_5_DESC "Go to Zero Point"
  #define MAIN_MENU_ITEM_5_GCODE "G90 \n G0 X0Y0Z0A0B0 \n G91"
  //#define MAIN_MENU_ITEM_5_CONFIRM  
  
  #define MAIN_MENU_ITEM_6_DESC "Gripper Fully Open"
  #define MAIN_MENU_ITEM_6_GCODE "M42 P4 S185"
  //#define MAIN_MENU_ITEM_5_CONFIRM
    
  #define MAIN_MENU_ITEM_7_DESC "Gripper Half Open"
  #define MAIN_MENU_ITEM_7_GCODE "M42 P4 S120"
  //#define MAIN_MENU_ITEM_5_CONFIRM
    
  #define MAIN_MENU_ITEM_8_DESC "Gripper Fully Closed"
  #define MAIN_MENU_ITEM_8_GCODE "M42 P4 S85"
  //#define MAIN_MENU_ITEM_5_CONFIRM
#endif
